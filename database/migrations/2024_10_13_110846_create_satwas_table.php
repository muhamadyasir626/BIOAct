...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('satwas', function (Blueprint $table) {
            ...
            $table->string('no_ba_tagging',255)->nullable();
            $table->string('no_ba_titipan',255)->nullable();
            $table->string('no_ba_kelahiran',255)->nullable();
            $table->string('no_ba_kematian',255)->nullable();
            $table->string('nama_panggilan_satwa',50)->nullable();
            $table->string('slug_nama_panggilan')->nullable();
